...
def upgrade() -> None:
    ...
    if "ix_collection_runs_job_key_started_at" not in index_names:
        op.create_index(
    ...
    if "ix_collection_runs_provider_target_date" not in index_names:
        op.create_index(
    ...
    if "ix_collection_runs_status_finished_at" not in index_names:
        op.create_index(
